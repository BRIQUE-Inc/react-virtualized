...
/*#__PURE__*/
function (_Component) {
  _inherits(VirtualizedTable, _Component);
  ...
  function VirtualizedTable(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VirtualizedTable).call(this, props));
    _this.state = {
  ...
  _createClass(VirtualizedTable, [{
    ...
    value: function render() {
      ...
      if (isFixedRow && isFixedCol) {
        ...
        fixedCorner = renderFixedCorner(_style, _fixedCorner);
      } // make rows
      ...
      for (var _i = 0; _i < renderRowCount; _i++) {
        ...
        for (var _j = 0; _j < renderColCount; _j++) {
          ...
          row.push(renderItem(_rIdx2, _cIdx2, _style2));
        }
        ...
        rows.push(renderRow(_rIdx2, rowStyle, row));
      }
...
_defineProperty(VirtualizedTable, "propTypes", {
...
_defineProperty(VirtualizedTable, "defaultProps", {
  height: 300,
  width: 300,
  style: {},
  rowCount: 1000,
  ...
  renderFixedCol: function renderFixedCol(style, children, ref) {
    return _react.default.createElement("div", {
      ref: ref,
      style: style
    }, children);
  },
  renderFixedColItem: function renderFixedColItem(rowIdx, style) {
    return _react.default.createElement(_tableCell.default, {
      key: "".concat(rowIdx, ",-1"),
      style: style
    }, "COL".concat(rowIdx));
